  ...
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh]">
        ...
        <p>
          A crowdfunding platforms for creators. Get funded by your own fans and
          followers. Start now!
        </p>
        <div>
          <Link href={"/login"}>
        ...
        <div className="flex gap-5 justify-around">
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <img
              ...
              alt=""
            />
            <p className="font-bold">Grow Career</p>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        ...
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/cZ590Z8ROws?si=m1BlPIxXEH8X9ifn"
